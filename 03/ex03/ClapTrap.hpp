...
/*   Updated: 2025/02/28 21:05:42 by etien            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
	// changed to protected to make variables accessible to derived class
	protected:
		std::string _name;
	...
	public:
		...
		void setMaxHitPoints(unsigned int const attackDamage);
