...
/*   Updated: 2025/04/10 17:33:38 by etien            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		try
		{
			std::cout << "\nemptyArray[0]: " << emptyArray[0] << std::endl;
		}
	...
	}
	{
		...
		std::cout << "\noriginalArray[0]: " << originalArray[0]
		...
		std::cout << "Changing copyArray values." << std::endl;
		copyArray[0] = 10;
		copyArray[1] = 20;
		copyArray[2] = 30;
		copyArray[3] = 40;
	...
	}
	{
		...
		std::cout << "Size of copyArray: " << copyArray.size() << std::endl;
		std::cout << std::left
					<< "\noriginalArray[0]: " << std::setw(10) << originalArray[0]
					<< "; copyArray[0]: " << std::setw(10) <<  copyArray[0] << std::endl
					<< "originalArray[1]: " << std::setw(10) << originalArray[1]
					<< "; copyArray[1]: " << std::setw(10) << copyArray[1] << std::endl
					<< "originalArray[2]: " << std::setw(10) << originalArray[2]
					<< "; copyArray[2]: " << std::setw(10) << copyArray[2] << std::endl
					<< "originalArray[3]: " << std::setw(10) << originalArray[3]
					<< "; copyArray[3]: " << std::setw(10) << copyArray[3] << std::endl
					<< "originalArray[4]: " << std::setw(10) << originalArray[4]
					<< "; copyArray[4]: " << std::setw(10) << copyArray[4] << std::endl;
